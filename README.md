...
| `BUILDKITE_SPLITTER_RESULT_PATH` | Test Splitter needs to read the result generated by the test runner, and will replace `{{resultPath}}` set in the `BUILDKITE_SPLITTER_TEST_CMD` with this value. |
