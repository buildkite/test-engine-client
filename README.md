...
| `BUILDKITE_SPLITTER_TEST_CMD` | `bundle exec rspec --format progress {{testExamples}}` | Test command to run your tests. Test Splitter will fill in the `{{testExamples}}` placeholder with the test splitting results. |
