...
func TestPytestPantsRun(t *testing.T) {
	...
	pytest := NewPytestPants(RunnerConfig{
		TestCommand: "pants test //passing_test.py -- --json={{resultPath}}",
	})
...
func TestPytestPantsRun_RetryCommand(t *testing.T) {
	...
	pytest := NewPytestPants(RunnerConfig{
		TestCommand:      "pants test //failing_test.py -- --json={{resultPath}}",
		RetryTestCommand: "pants test //passing_test.py -- --json={{resultPath}}",
	})
...
func TestPytestPantsRun_CommandFailed(t *testing.T) {
	...
	pytest := NewPytestPants(RunnerConfig{
		TestCommand: "pants test //:: -- --non-existent-pytest-option --json={{resultPath}}",
	})
...
func TestPytestPantsCommandNameAndArgs_WithResultPath(t *testing.T) {
	...
	wantName := "pants"
	wantArgs := []string{"test", "//::", "--", "--json=result.json"}
...
func TestPytestPantsCommandNameAndArgs_InvalidTestCommand(t *testing.T) {
	testCases := []string{"failing_test.py", "passing_test.py"}
	testCommand := "pants test //:: '{{resultPath}}"
