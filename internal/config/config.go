...
type Config struct {
	...
	// QueueAccessToken is the token used for Test Engine queue API calls.
	QueueAccessToken string `json:"-"`
	// QueueBatchSize is the number of tests leased by each queue worker pop.
	QueueBatchSize int `json:"-"`
	// QueueLeaseSeconds is the queue lease duration in seconds.
	QueueLeaseSeconds int `json:"-"`
	// QueueName identifies the logical test queue inside a build.
	QueueName string `json:"-"`
	// QueueOIDCAudience is the audience used when minting queue OIDC tokens.
	QueueOIDCAudience string `json:"-"`
	// QueueOrganizationUUID is the organization UUID sent to the queue service.
	QueueOrganizationUUID string `json:"-"`
	// QueuePipelineSlug is the Buildkite pipeline slug sent to the queue service.
	QueuePipelineSlug string `json:"-"`
	// QueuePollSeconds is the sleep duration between empty worker polls.
	...
	QueueStepKey string `json:"-"`
	// QueueSuiteUUID is the suite UUID sent to the queue service.
	QueueSuiteUUID string `json:"-"`
	// QueueUUID identifies an existing queue for inspection commands.
	QueueUUID string `json:"-"`
